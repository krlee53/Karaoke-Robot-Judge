...
layout = [  [sg.Text('Karaoke',  background_color=heading_color)],
            [sg.RealtimeButton('Start', key='pushbut01', font='Helvetica 12'),
			sg.RealtimeButton('Pause/Resume', key='pushbut02', font='Helvetica 12'),
			sg.RealtimeButton('Quit', key='pushbut03', font='Helvetica 12')],
            #
            [sg.Text('Song Selection', background_color=heading_color)],
            [sg.Listbox(values=['Save Me', 'You Belong With Me', 'Lost Stars'], key='list1', size=(20, 3),
